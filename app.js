...
var favicon = require('serve-favicon');//处理收藏夹图标   favicon.ico
var logger = require('morgan');//是一个请求日志打印工具
var cookieParser = require('cookie-parser');//处理cookie 效果：增加req.cookies属性
...
// 在你将收藏夹图标放置在/public目录下后就可以取消掉此注释
